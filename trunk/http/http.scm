...
(module
  ...
  *current-http-context*
  (current-http-query #!optional)
  (current-http-params #!optional)
  (current-http-cookies #!optional)
  (current-http-path #!optional)

  (current-http-method #!optional)
  (current-userid #!optional)
  (current-document-base #!optional)
  (current-http-url #!optional)
  (current-http-cookies-attributes #!optional)
  (current-http-request-uri #!optional)
  (current-http-script-name #!optional)
  ...
  (current-query-disposition #!optional)
  (current-query-content-type #!optional)
  )
 )
